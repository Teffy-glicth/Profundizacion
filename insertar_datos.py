...
with app.app_context():
    nuevo_modelo = Modelo(
        ...
        - Robustez ante características irrelevantes: Mitiga el impacto de variables poco informativas en las predicciones finales. Tipos de modelos: Incluye variantes como Gaussiano (para datos continuos), Multinomial (conteos de frecuencias) y Bernoulli (datos binarios). 
